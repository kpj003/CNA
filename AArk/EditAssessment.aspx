...
<asp:Content ID="Content1" ContentPlaceHolderID="cntApp" runat="server">
    ...
    <script type="text/javascript">
        ...
        if (curlanguage.toUpperCase() == 'SPANISH') { msg = 'Has hecho cambios en esta página que no has guardado. Si navegas fuera de esta página, perderás los cambios.'; }
        else {
    ...
    <p style="text-align: left" class="TextParagraph">
        <asp:Label runat="server" ForeColor="Red" ID="lblError" CssClass="TextError"></asp:Label></p>
                                ...
                                <div class="left">
                                 ...
                                 <asp:Label ID="lblPrompt1" runat="server" Font-Italic="true" Font-Bold="true"></asp:Label>
                                   ...
                                   <a runat="server" id="lnkQ2">
                                       <img id="imgQ2" runat="server" src="images/Question_mark%2025%20px.png" /></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                 ...
                                 <asp:Label ID="lblPrompt2" runat="server" Font-Italic="true" Font-Bold="true"></asp:Label>
                                   ...
                                   <a runat="server" id="lnkQ3">
                                       <img id="img3" runat="server" src="images/Question_mark%2025%20px.png" /></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                 ...
                                 <asp:Label ID="lblPrompt3" runat="server" Font-Italic="true" Font-Bold="true"></asp:Label>
                                   ...
                                   <a runat="server" id="lnkQ4">
                                       <img id="img4" runat="server" src="images/Question_mark%2025%20px.png" /></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
            ...
            <table style="width: 980px">
                <tr>
                    <td>
                        <br />
                        <p style="text-align: center" class="TextHeader">
                            <asp:Label runat="server" ID="lblS2Header"></asp:Label></p>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top">
                            ...
                            <ContentTemplate>
                                <div class="left">
                                   ...
                                   <a runat="server" id="lnkQ5">
                                       <img id="img5" runat="server" src="images/Question_mark%2025%20px.png" /></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                 ...
                                 <asp:Label ID="lblPrompt5" runat="server" Font-Italic="true" Font-Bold="true"></asp:Label>
                                   ...
                                   <a runat="server" id="lnkQ6">
                                       <img id="img6" runat="server" src="images/Question_mark%2025%20px.png" /></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
            ...
            <table style="width: 980px">
                <tr>
                    <td>
                        <br />
                        <p style="text-align: center" class="TextHeader">
                            <asp:Label runat="server" ID="lblS3Header"></asp:Label></p>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top">
                            ...
                            <ContentTemplate>
                                <div class="left">
                                   ...
                                   <a runat="server" id="lnkQ7">
                                       <img id="img7" runat="server" src="images/Question_mark%2025%20px.png" /></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
            ...
            <table style="width: 980px">
                <tr>
                    <td>
                        <br />
                        <p style="text-align: center" class="TextHeader">
                            <asp:Label runat="server" ID="lblS4Header"></asp:Label></p>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top">
            ...
            <table style="width: 980px">
                <tr>
                    <td>
                        <br />
                        <p style="text-align: center" class="TextHeader">
                            <asp:Label runat="server" ID="lblS5Header"></asp:Label></p>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top">
                                ...
                                <div class="left">
                                 ...
                                 <asp:Label ID="lblPrompt14" runat="server" Font-Italic="true" Font-Bold="true"></asp:Label>
                                   ...
                                   <a runat="server" id="lnkQ15">
                                       <img id="img15" runat="server" src="images/Question_mark%2025%20px.png" /></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
            ...
            <table style="width: 980px">
                <tr>
                    <td>
                        <br />
                        <p style="text-align: center" class="TextHeader">
                            <asp:Label runat="server" ID="lblS6Header"></asp:Label></p>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top">
            ...
            <table style="width: 100%;">
                <tr>
                    <td>
                        <br />
                        <p style="text-align: center" class="TextHeader">
                            <asp:Label runat="server" ID="lblS7Header"></asp:Label></p>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align: top">
                        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                            ...
                            <a runat="server" id="lnkQ19">
                                <img id="img19" runat="server" src="images/Question_mark%2025%20px.png" /></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                 ...
                                 <asp:Label ID="lblPrompt19" runat="server" Font-Italic="true" Font-Bold="true"></asp:Label>
                                   ...
                                   <a runat="server" id="lnkQ20">
                                       <img id="img20" runat="server" src="images/Question_mark%2025%20px.png" /></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
