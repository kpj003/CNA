...
namespace AArk
{
    public partial class CreateAssessmentBKUP : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["UserName"] == null)
            {
                ...
                string strURL = "Login.aspx?SpeciesID=" + intSpeciesID.ToString();
