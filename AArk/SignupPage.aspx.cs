    ...
    public partial class SignupPage : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int iNewID = DataProxy.InsertUser(txtFirstName.Text.Trim(), txtLastName.Text.Trim(), txtLoginName.Text.Trim(), txtPassword.Text.Trim(),
                                 txtTitle.Text.Trim(), txtEmail.Text.Trim(), txtOrganization.Text.Trim(), ddlLanguages.SelectedValue, ddlCountries.SelectedValue, chkASGMbr.Checked);
