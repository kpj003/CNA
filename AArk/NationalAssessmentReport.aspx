<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NationalAssessmentReport.aspx.cs" Inherits="AArk.NationalAssessmentReport" %>
    ...
    <p style="text-align:left" class="TextParagraph"><asp:Label runat="server" ForeColor="Red" ID="lblError" CssClass="TextError"></asp:Label></p>
      ...
      <table style="align-items:center;align-self:center; text-align:center; align-content:center; border-spacing:4px; width:980px"> 
         ...
         <td style="text-align:left; vertical-align:bottom; text-wrap:none">
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;
           <asp:Label runat="server" ID="lblTriggers"></asp:Label>&nbsp;
             &nbsp;&nbsp;<asp:DropDownList runat="server" ID="ddlTriggers"></asp:DropDownList>
                 &nbsp;&nbsp;
            ...
            <asp:GridView ID="grdAssessUser" runat="server" Visible="false" HeaderStyle-Font-Names="Arial" Font-Names="Arial" Font-Size="12px"  
                ...
                <Columns> 
                      ...
                      <asp:TemplateField HeaderText="Species" HeaderStyle-Wrap="false">
                         <ItemTemplate>
                            <asp:HyperLink ID="lblSpecies" Text='<%# Eval("ScientificName") %>' runat="server" NavigateUrl=''></asp:HyperLink>
                         </ItemTemplate>    
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Conservation Action" HeaderStyle-Wrap="false">
                        <ItemTemplate>                                   
