...
namespace AArk
{
    public partial class ConsolidatedSpeciesAssessment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblReportTitle.Text = DataProxy.LoadString("CONSOLIDATEDASSESSMENTTITLE", strCurrentLanguage);
        ...
        protected void PopulateQuestionsGrid()
        {
            try
            {
                ...
                //NEED TO CREATE DBO RESPONSES COMMENTS CONCAT AND ADD TO THIS QUERY:
                DataTable dtAssess = DataProxy.GetConsolidatedQAGrid(intLanguageID, intSpeciesID, intCountryID);
        ...
        protected void grdAssess_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                e.Row.Cells[3].Text = DataProxy.LoadString("CONSOLIDATEDRESPONSELABEL", strCurrentLanguage);
                ...
                if (e.Row.FindControl("hlQuestion") != null)
                {
                    ...
                    else
                    {
                        if (strCurrentLanguage == "Spanish")
                            ...
                            strURL = "/Help/FR/QuestionsAnswers.htm#q" + strQuestionID;
                    }
