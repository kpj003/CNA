<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateAssessment - BKUP B4 UPDPANEL.aspx.cs" Inherits="AArk.CreateAssessmentBKUPB4UPDATEPANEL" %>
     ...
     <table style="width:980px" cellpadding="0" cellspacing="0">
        ...
        <br /><br /></td>
         ...
         <tr><td style="text-align:center" colspan="7">
             <asp:CheckBox ID="chkComplete" runat="server" /><br /><br />
             <asp:Button runat="server" id="Button1" Text="Save Assessment" OnClick="btnSave_Click"/>
             <br />
             <br />
             </td></tr>
    </table>
                    ...
                    <table style="width: 900px">
                        <tr>
                            <td style="vertical-align:top" class="TextText">
                                    <asp:Label ID="lblQ1" runat="server" Width="950" Font-Bold="true"></asp:Label>
                               </td></tr>
                                <tr><td>
                        ...
                        <tr>
                            <td style="vertical-align:top" class="TextText">
                               <asp:Label ID="lblQ2" Width="950" runat="server" Font-Bold="true"></asp:Label>
                               </td></tr>
                                <tr><td>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td style="vertical-align:top" class="TextText">
                                    <asp:Label Width="950" ID="lblQ3" runat="server" Font-Bold="true"></asp:Label>
                                </td></tr>
                                <tr><td>
                            ...
                            <tr>
                                <td style="vertical-align:top" class="TextParagraph" >
                                     <asp:TextBox ID="txtComments3" runat="server" Width="950px" TextMode="MultiLine"></asp:TextBox>
                                     <br />
                                    <br />
                                </td>
                            </tr>
                        <tr>
                            <td style="vertical-align:top" class="TextText">
                               <asp:Label ID="lblQ4" Width="950" runat="server" CssClass="TextText" Font-Bold="true"></asp:Label>
                               </td></tr>
                                <tr><td>
        ...
        <tr>
            <td style="vertical-align:top">
                <table style="width: 900px">
                    <tr>
                    <td style="vertical-align:top" class="TextText">
                        <asp:Label ID="lblQ5" runat="server" Font-Bold="true" Width="950"></asp:Label>
                    </td></tr>
                                <tr><td>
                    ...
                    <td style="vertical-align:top" class="TextText"><br />
                        <asp:Label ID="lblQ6" runat="server" Font-Bold="true" Width="950"></asp:Label>
                    </td></tr>
                                <tr><td>
             ...
             <tr>
                <td style="vertical-align:top">
                    <table style="width: 900px">
                        <tr>
                            <td style="vertical-align:top" class="TextText"><br />
                                    <asp:Label ID="lblQ7" runat="server" Font-Bold="true" Width="950"></asp:Label>
                             </td></tr>
                                <tr><td>
        ...
        <tr>
            <td style="vertical-align:top">
                <table style="width: 900px">
                    ...
                    <tr>
                        <td style="vertical-align:top" class="TextText"><br />
                            <asp:Label ID="lblQ15" runat="server" Font-Bold="true" Width="950"></asp:Label><br />
                         </td></tr>
                         <tr><td>
            ...
            <td style="vertical-align:top">
                <table style="width: 950px">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td style="vertical-align:top" class="TextText"><br />
                            <asp:Label ID="lblQ19" runat="server" Font-Bold="true" Width="950"></asp:Label>
                         </td></tr>
                         <tr><td>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td style="vertical-align:top" class="TextText"><br />
                            <asp:Label ID="lblQ20" runat="server" Font-Bold="true" Width="950"></asp:Label>
                        </td></tr>
                         <tr><td>
