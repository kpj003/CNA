<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="AArk.EditUser" %>
...
<tr>
    ...
    <td class="userFormField" valign="top" align="left">
        <asp:TextBox ID="txtLoginName" runat="server"  Width="200" Enabled="false"></asp:TextBox>
    </td>
</tr>
<tr>
     <td valign="top" align="left" class="style1"><p style="POSITION: static; MARGIN-TOP: 3px; CLEAR: none" class="TextText">
