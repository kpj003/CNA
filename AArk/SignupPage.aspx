<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SignupPage.aspx.cs" Inherits="AArk.SignupPage" %>
...
<tr>
    ...
    <td align="left">
        <asp:CheckBox ID="chkASGMbr" runat="server" />
        <br />
    </td>
</tr>        
<tr>
