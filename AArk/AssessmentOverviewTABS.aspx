<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AssessmentOverviewTABS.aspx.cs" Inherits="AArk.AssessmentOverviewTABS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cntApp" runat="server">  

    <table width="80%" align="center">
        <tr><td> <p style="text-align:center" class="TextHeader"><br />
        <font size="4"><asp:Label runat="server" ID="lblPageTitle"></asp:Label></font></p>
        </td></tr>
      <tr>
        <td>
          <asp:Button Text="Page 1" BorderStyle="None" ID="Tab1" CssClass="Initial" runat="server" OnClick="Tab1_Click" />
          <asp:Button Text="Page 2" BorderStyle="None" ID="Tab2" CssClass="Initial" runat="server" OnClick="Tab2_Click" />
